        ...
        {showAdd && (
          <View style={{ height: 50, flexDirection: 'row' }}>
            ...
            <TouchableOpacity onPress={handleNewBookAdd}>
              <View style={{ width: 50, height:50, backgroundColor: '#2dcc45', alignItems: 'center', justifyContent: 'center' }}>
                <Ionicons name="checkmark" color='white' size={30} />
              </View>
            </TouchableOpacity>
            <TouchableOpacity  onPress={handleCloseBook}>
              <View style={{ width: 50 , height:50, backgroundColor: '#f99', alignItems: 'center', justifyContent: 'center' }}>
